        ...
        <div className="bg-white mt-12 p-12 grid gap-12">
            ...
            {flowers.map((el, i) => (
                <div className="flex justify-center space-x-12" key={i}>
                    <img
                        className="w-36 h-56"
                        src="https://images.unsplash.com/photo-1560790671-b76ca4de55ef?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8JUVBJUJEJTgzfGVufDB8fDB8fHww"
                    />
                    <div className="w-full flex-col content-end space-y-2">
                        <p className="font-extrabold text-xl">{flowerName[el.theme_name]}({el.theme_name})</p>
